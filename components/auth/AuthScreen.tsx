...
const AuthScreen: React.FC<AuthScreenProps> = ({ onAuthSuccess }) => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // L'utilisateur sera redirigé vers Google, puis de retour vers /game
    } catch (err: any) {
        ...
        <div className="bg-gradient-to-br from-gray-900/40 to-black/40 backdrop-blur-xl border-2 border-amber-500/20 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="mt-6">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white hover:bg-gray-50 text-gray-700 font-semibold rounded-xl transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed border border-gray-200"
            >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gradient-to-br from-gray-900/40 to-black/40 text-gray-400">
                OU
              </span>
            </div>
          </div>
