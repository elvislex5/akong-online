        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-2">
            {navLinks.map((link) => (
              <Link
                ...
                className={`relative px-6 py-3 rounded-xl font-semibold transition-all duration-300 ${isActive(link.path)
                    ? 'text-amber-400'
                    : link.enabled
          ...
          <div className="hidden md:flex items-center space-x-4">
            {isAuthenticated && (
              <Link
                to="/profile"
                className={`px-6 py-3 rounded-xl font-semibold flex items-center gap-2 transition-all duration-300 shadow-lg ${isActive('/profile')
              ...
              {navLinks.map((link, index) => (
                ...
                >
                  <Link
                    ...
                    className={`block px-6 py-4 rounded-xl font-semibold transition-all ${isActive(link.path)
              ...
              {isAuthenticated && (
                ...
                >
                  <Link
                    ...
                    className="w-full px-6 py-4 bg-gradient-to-r from-amber-500 to-orange-600 rounded-xl font-semibold text-white flex items-center justify-center gap-2 mt-4"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
